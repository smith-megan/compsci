...
// O(n)
// '(could be O(1) since we know length of numbers array)'
...
// O(1)
// 'can only go up to count of 4 regardless of array length'
...
console.log(squareEveryDigit(946)) //O(1)